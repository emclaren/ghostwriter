...
var welomeScreen = document.getElementById('welcome-screen');
...
var formImage= ["hr0081-1.jpg", "hr0081-2.jpg","hr0081-3.jpg"];

// Randomly assigns a treatment
var formNumber = Math.floor(Math.random()*formImage.length);


// Print which form this will be
console.log(formImage[formNumber])
...
function submit() {
  ...
  link.setAttribute("download", "stubs-data "+formImage[formNumber]+".csv");
